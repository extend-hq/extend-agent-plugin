...
The skills are vendored snapshots; their sources of truth live elsewhere:

- `skills/extend-platform/SKILL.md` is maintained in
  [extend-hq/documentation](https://github.com/extend-hq/documentation) under
  `skills/extend-platform/`.
- `skills/extend-cli/SKILL.md` is generated by the CLI itself
  (`extend skill`) from [extend-hq/extend-cli](https://github.com/extend-hq/extend-cli).
  Regenerate after CLI releases: `extend skill > skills/extend-cli/SKILL.md`.
...
[privacy policy](https://www.extend.ai/privacy) and
